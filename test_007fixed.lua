...
local STATE={
    ...
    parryVisualCollapseTime=1.5,
    parryVisualExpandTime=1.0,
    parryVisualCooldown=2.5,
    ...
    function toggleAutoParryESP(state)
        if state then
            ...
            espLoop=RunService.RenderStepped:Connect(function()
                ...
                elseif pulseAt>0 and pulseElapsed<STATE.parryVisualCooldown then
                    local expandElapsed=pulseElapsed-STATE.parryVisualCollapseTime
                    local t=math.clamp(
