...
local KillerAimingFeature=(function()
    ...
    local function createAlwaysLine(char)
        ...
        local data={
            ...
            sourceRoot=root,
            sourceHead=head,
            length=math.clamp(tonumber(STATE.alwaysLineLength) or 50,10,100),
            color=WHITE
        }
    ...
    local function updateAlwaysLine(char)
        ...
        data.sourceRoot=root
        data.sourceHead=head
        data.length=math.clamp(tonumber(STATE.alwaysLineLength) or 50,10,100)
...
local function heavenGroundPoint(char,point)
    ...
    local function setAlwaysLineLength(v)
        STATE.alwaysLineLength=math.clamp(tonumber(v) or 50,10,100)
        ...
        if lineAlways then
            ...
            if killer then
                ...
                if data then
                    data.length=STATE.alwaysLineLength
                end
