...
local KillerAimingFeature=(function()
    ...
    local HEAVEN_DISTANCE=16
    local HEAVEN_HALF_ANGLE=38
    local HEAVEN_RAY_COUNT=7
    local HEAVEN_SEGMENTS=10
    local HEAVEN_CURVE=0.34
    ...
    local function updateHeavenEyes(char)
        ...
        local total=HEAVEN_RAY_COUNT*HEAVEN_SEGMENTS
        ...
        for rayIndex=1,HEAVEN_RAY_COUNT do
            local side

            if HEAVEN_RAY_COUNT<=1 then
                side=0
            else
                side=((rayIndex-1)/(HEAVEN_RAY_COUNT-1))*2-1
            end
            ...
            for segment=1,HEAVEN_SEGMENTS do
                ...
                local halfWidth=
                    math.tan(math.rad(HEAVEN_HALF_ANGLE))
                    *HEAVEN_DISTANCE
                ...
                local point=
                    origin
                    +forward*(HEAVEN_DISTANCE*t)
                    +right*(x+curve)
                    +up*(0.10*math.sin(t*math.pi))
