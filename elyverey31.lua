...
local KillerAimingFeature=(function()
    ...
    local function createLine(store,char,color,prefix)
        ...
        -- Keep the source attached to the live HumanoidRootPart.
        -- This prevents the line from becoming a frozen world-space line
        -- when the Killer's Head/character moves.
    ...
    local function updateLine(data,char)
        ...
        -- Rebind the source if Roblox replaced the character parts.
        if data.startAttachment.Parent ~= root then
            data.startAttachment.Parent=root
        end
        ...
        data.startAttachment.WorldPosition=root.Position
